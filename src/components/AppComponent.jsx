...
const showJava = () => { return <JavaDataService /> },
        showMS = () => { return <MSDataService /> },
        showJS = () => { return <JSDataService /> },
        FAQ = () => {
...
class AppComponent extends React.Component { 
    ...
    render() {
        return <div className="grid-container">
            <Router>
                <div>
                <AppBar centered className="tech-appbar" title="Techradar" position="static" color="default">

                <Tabs className="tech-tabs" centered  value={this.state.value} onChange={this.handleChange}>
